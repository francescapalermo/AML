...
class KDAttributeTree(scipy.spatial.KDTree):
    def __init__(
        ...
        **kwargs,
        ...
        if attributes is None:
            ...
            raise TypeError(
                "attributes must be None, np.ndarray, or list of np.ndarrays."
            )

        assert np.all(
            [len(a) == len(data) for a in self.attributes]
    ...
    def query_ball_point(
        ...
        typing.Union[
            ...
            typing.Union[typing.List[np.ndarray], typing.List[typing.List[np.ndarray]]],
        ],
    ]:
        """
        ...
        if self.attributes is None:
            ...
            if len(self.attributes) == 1:
                ...
                a = [
                    [ax[np.asarray(ix, dtype=int)] for ax in self.attributes]
                    for ix in i
                ]
